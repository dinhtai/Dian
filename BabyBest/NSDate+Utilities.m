...
//dangnv
- (NSString *)toStringWithFormat:(NSString *)formatString{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:formatString];
    return [dateFormatter stringFromDate:self];
}

+ (NSString *)dateStringWithFormat:(NSString *)outputFormat fromDateString:(NSString *)dateString inputFormat:(NSString *)inputFormat{
    @try {
        NSDate *date = [NSDate dateFromString:dateString format:inputFormat];
        return [date toStringWithFormat:outputFormat];
    }
